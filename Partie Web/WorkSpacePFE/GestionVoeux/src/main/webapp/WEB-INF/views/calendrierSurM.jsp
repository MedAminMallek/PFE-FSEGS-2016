...
<head>
 ...
 <body>
	...
	<form action="validerParamSur" method="post">
		 			...
		 			<div class="col-md-15">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4 align="center"><b>Calendrier des surveillances</h4>
                        </div>
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            
                            <br>
                            <h3 align="center">Nombre des enseignants surveillants requis pour chaque séance</h3>
                            <br>
                            
                           <table align="center" border="2" style="width:50%">
                            	<tr bgcolor="#2E9AFE"><td width="150"></td>
                            		<!--    <td width="50"></td>-->
                            	...
                            	<tr>
                            		<td width="150" rowspan="1" bgcolor="#2E9AFE">${j.affichageDate()}</td>
                            	<!--  	<td width="50">Surveillants</td> -->
                            		<c:forEach items="${heures}" var="h">
                            		<td align="center" width="30">
                            		
                            		<c:forEach items="${j.seanceExamens}" var="s">
                            			<c:if test="${s.heureDebut.equals(h)}">
                            				<font size="5" color="black">${s.nombreSurveillant}</font> <!-- <input disabled="disabled" type="number" min="${s.nombreSurveillant}" required="required" value="${s.nombreSurveillant}" name="${j.date} P ${s.heureDebut}"  style="width:60px;"> -->  
                            			</c:if>
                            		</c:forEach>
                            	...
                            	<!--  <tr>
                            		...
                            		<c:forEach items="${j.seanceExamens}" var="s">
                            			<c:if test="${s.heureDebut.equals(h)}">
                            				<input type="number"  min="1" required="required" value="${s.nombreCommission}" name="${j.date} M ${s.heureDebut}"  style="width:60px;">  
                            			</c:if>
                            		</c:forEach>
