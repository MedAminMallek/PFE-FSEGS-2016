                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            ...
                            <br>
                            <br>
                            <form action="chargerconsulterAbsence" method="post">
                           	<table align=center>
                         		...
                         		<tr align="center"><td><input type="submit" value="Afficher" name="bt1">
                         		</c:if>
                         		<c:if test="${empty listeS}">
                         		<tr align="center"><td><input type="submit" value="Continuer" name="bt1">
                         		</c:if>
                           	</table>
                         	</form>
                          </div>
