		 	...
		 	<div class="col-md-15">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4 align="center"><b>Liste des absences</h4>
                        </div>
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            <h3 align="center"><b>${ens}</h3>
                            <br>
                            <table align="center" border="1">
                            <tr align="center" bgcolor="#2E9AFE"><td>Journée<td>Séance
                            <c:forEach items="${liste}" var="a">
                            	
                            	<tr><td>${a.date()}<td>${a.heure()}
                            	
                            </c:forEach>
                            <tr><td colspan="2" align="center"><a href="${lien}" target="XX">Imprimer</a>
                            </table>
